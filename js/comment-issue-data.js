...
var repoIssuesUrl = "https://api.github.com/repos/tagbug/blog_comment/issues";
// 对应仓库 clientId、clientSecret 关于这两个参数的安全问题，查看 https://removeif.github.io/2019/09/19/博客源码分享.html#1-热门推荐，最新评论：
var clientId = "6cf17625e3e2a9b3a753";// = "46a9f3481b46ea0129d8";
var clientSecret = "ef93ca6900a618b780fa96e4eb6434b786afbaff";// = "79c7c9cb847e141757d7864453bcbf89f0655b24";
...
function loadIssueData(appId, appKey, userName, userRepo, isValine) {
    ...
    setTimeout(function () { // 延迟1s执行，保证其余的先加载
        ...
        // console.clear();
        console.log("~~~~欢迎光临！记得有时间多来看看哦，https://tagbug.gitlab.io/ ~~~~")
    }
        ,
        500
    )
